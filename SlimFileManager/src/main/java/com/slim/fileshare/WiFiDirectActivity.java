 ...
 */
public class WiFiDirectActivity extends ThemeActivity implements ChannelListener,
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_file_share, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.atn_direct_enable:
                if (manager != null && channel != null) {
                    ...
                    Log.e("channel or manager is null");
                }
                return true;
